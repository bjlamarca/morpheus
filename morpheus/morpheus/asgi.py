...
from tiles.routing import tiles_websocket_urlpatterns
websocket_urlpatterns =  hue_websocket_urlpatterns  + devices_websocket_urlpatterns  + scenes_websocket_urlpatterns + tiles_websocket_urlpatterns
