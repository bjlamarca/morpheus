...
def get_light_gamut_from_str(gamut_str):
    #A, B, C
    if gamut_str == 'A':
        return GamutA
    if gamut_str == 'B':
...
class ColorHelper:
    ...
    def __init__(self, gamut=GamutC):
        self.Red = gamut[0]
        self.Lime = gamut[1]
        self.Blue = gamut[2]
...
class Converter:
    ...
    def __init__(self, gamut_str='B'):

        self.color = ColorHelper(get_light_gamut_from_str(gamut_str))
